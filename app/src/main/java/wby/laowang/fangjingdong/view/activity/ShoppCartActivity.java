...
public class ShoppCartActivity extends AppCompatActivity implements IShoppCart {
    ...
    public void showShoppCart(ShoppCartBean shoppCartBean) {
        ...
        myExpanAdapter = new MyExpanAdapter(ShoppCartActivity.this, shoppCartBean.getData());
